...
class TemporalDifference(Agent[int, int]):
    ...
    def __init__(self, env: Env[int, int], gamma: float = 0.99) -> None:
        ...
        Attributes:
            ...
            q_values: Dictionary mapping states to numpy arrays of action values.
            visits: Dictionary mapping states to numpy arrays of visit counts per action.
        """
    ...
    def train(self,
        ...
        Args:
            alpha: Learning rate in (0, 1), or None to use 1/visit_count as the
                adaptive learning rate. Defaults to 0.1.
...
class SARSA(TemporalDifference):
    ...
    def update_q_value(self,
        ...
        Args:
            ...
            alpha: Learning rate, or None to use 1/visit_count as the adaptive
                learning rate.
...
class DoubleQLearning(TemporalDifference):
    ...
    def __init__(self, env: Env[int, int], gamma: float = 0.99):
        ...
        Attributes:
            q_values_1: Dictionary mapping states to numpy arrays of action values
                for the first Q-network.
            q_values_2: Dictionary mapping states to numpy arrays of action values
                for the second Q-network.
            visits: Dictionary mapping states to numpy arrays of visit counts per action.
        """
