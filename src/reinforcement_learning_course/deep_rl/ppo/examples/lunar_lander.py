...
if __name__ == '__main__':
    ...
    argparser.add_argument('--gamma', type=float, default=0.999, help="Discount factor of the MDP.")
    ...
    argparser.add_argument('--lambd', type=float, default=0.98, help="Lambda parameter for calculating the GAE.")
    argparser.add_argument('--n_train', type=int, default=10000, help="Number of training episodes.")
    argparser.add_argument('--t_max', type=int, default=1024, help="Number of steps between two consecutive gradient updates.")
    ...
    argparser.add_argument('--alpha_entropy', type=float, default=0.01, help="Penalty on the entropy loss term.")
