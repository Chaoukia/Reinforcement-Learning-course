...
def train_a2c_lunar_lander(worker_id,
    ...
    """Worker function for A2C training on LunarLander-v3.

    Creates a LunarLander environment and A2C agent, then delegates to the shared
...
if __name__ == '__main__':
    ...
    env = gym.make("LunarLander-v3", continuous=False, gravity=-10.0,enable_wind=False, wind_power=0.0, turbulence_power=0.0)
    agent = agents.LunarLanderA2C(env, args.n_workers, args.gamma)
    ...
    processes = [mp.Process(target=train_a2c_lunar_lander, args=(i, 
                                                                policy_network,
                                                                value_network, 
                                                                policy_optimizer,
                                                                value_optimizer, 
