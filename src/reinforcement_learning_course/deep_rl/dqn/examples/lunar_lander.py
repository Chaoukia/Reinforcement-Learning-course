...
from reinforcement_learning_course.deep_rl.dqn.examples import agents
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--log_dir', type=str, default="runs", help="Path where to save tensorboard logs.")
    ...
    start_time = time()
    agent = agents.LunarLanderDQN(env, args.max_size, args.gamma, double_learning)
    start_time = time()
