...
if __name__ == '__main__':
    ...
    argparser.add_argument('--log_dir', type=str, default='runs_dqn', help="Directory in which to store the tensorboard events.")
    ...
    if args.train:
        ...
        agent = DQN(gamma=args.gamma, max_size=args.max_size)
