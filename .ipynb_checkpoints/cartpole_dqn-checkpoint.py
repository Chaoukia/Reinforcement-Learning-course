...
if __name__ == '__main__':
    ...
    argparser.add_argument('--fc_1_dim', type=int, default=4, help="Dimension of the first network layer.")
    argparser.add_argument('--fc_2_dim', type=int, default=4, help="Dimension of the second network layer.")
    ...
    argparser.add_argument('--log_dir', type=str, default='runs_cartpole_dqn', help="Directory in which to store the tensorboard events.")
    argparser.add_argument('--thresh', type=float, default=500, help="Average return over which we terminate training.")
    argparser.add_argument('--file_save', type=str, default='cartpole', help="File name of the saved weights.")
    ...
    if args.train:
        ...
        agent = DQN(gamma=args.gamma, input_size=4, fc_1_dim=args.fc_1_dim, fc_2_dim=args.fc_2_dim, out=2, max_size=args.max_size)
        agent.load_weights(args.file_load + '.pth')
