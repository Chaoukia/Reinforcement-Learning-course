...
from agents import CartPoleDQN
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--file_save', type=str, default='weights/cartpole_dqn.pth', help="Path where to save the network weights.")
    ...
    agent = CartPoleDQN(env, args.gamma, args.max_size, double_learning)
    start_time = time()
