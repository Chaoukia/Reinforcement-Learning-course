...
from agents import LunarLanderReinforce
...
if __name__ == '__main__':
    ...
    agent = LunarLanderReinforce(args.gamma)
    start_time = time()
    ...
    if args.save_gif:
        ...
        agent.save_gif(env, file_name='../../gifs/lunar_lander.gif', n_episodes=3, duration=30)
        env.close()