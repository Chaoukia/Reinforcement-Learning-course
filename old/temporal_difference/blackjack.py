...
from agents import BlackJackQLearning, BlackJackSARSA, BlackJackExpectedSARSA, BlackJackDoubleQLearning
...
if __name__ == '__main__':
    ...
    if args.algorithm == 'q_learning':
        agent = BlackJackQLearning(env, gamma=args.gamma)

    elif args.algorithm == 'sarsa':
        agent = BlackJackSARSA(env, gamma=args.gamma)

    elif args.algorithm == 'expected_sarsa':
        agent = BlackJackExpectedSARSA(env, gamma=args.gamma)

    elif args.algorithm == 'double_q_learning':
        agent = BlackJackDoubleQLearning(env, gamma=args.gamma)
