...
from agents import CliffWalkingQLearning, CliffWalkingSARSA, CliffWalkingExpectedSARSA, CliffWalkingDoubleQLearning
...
if __name__ == '__main__':
    ...
    if args.algorithm == 'q_learning':
        ...
        agent = CliffWalkingDoubleQLearning(env, gamma=args.gamma)
