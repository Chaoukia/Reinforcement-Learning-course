...
if __name__ == '__main__':
    ...
    argparser.add_argument('--file_load', type=str, default='cartpole', help="File name of the saved weights to load.")
    argparser.add_argument('--gamma', type=float, default=0.99, help="Discount factor of the MDP.")
    argparser.add_argument('--fc_1_dim', type=int, default=16, help="Dimension of the first network layer.")
    argparser.add_argument('--fc_2_dim', type=int, default=8, help="Dimension of the second network layer.")
    ...
    argparser.add_argument('--n_train', type=int, default=5000, help="Number of training episodes.")
    ...
    argparser.add_argument('--decay_rate', type=float, default=1e-5, help="Decay rate of epsilon.")
    ...
    argparser.add_argument('--max_tau', type=int, default=20, help="Number of iterations between two consecutive updates of the weights of the target network.")
    argparser.add_argument('--log_dir', type=str, default='runs_cartpole', help="Directory in which to store the tensorboard events.")
    argparser.add_argument('--thresh', type=float, default=480, help="Average return over which we terminate training.")
    argparser.add_argument('--file_save', type=str, default='cartpole.pth', help="File name of the saved weights.")
    ...
    if args.train:
        ...
        agent = DQN(gamma=args.gamma, input_size=4, fc_1_dim=args.fc_1_dim, fc_2_dim=args.fc_2_dim, out=2, max_size=args.max_size)
